...
2.1, $P(X = 0)$, is approximated using $P(-.5<=X<=.5)$, though we cannot have a negative value here, and so we use the cumulative probability from 0 to 0.5 using `pnorm(-.5,mean = 17.25,sd = 3.361)` = $6.418205e-08$, versus the Binomial's value of 6.487315e-10 (Normal approximation is higher).
...
2.2, $P(X \leq 9)$, is approximated using $P(X \leq 9.5)$, pnorm(9.5,mean = 17.25,sd = 3.361) = $0.01055919$, versus the Binomial's value of 0.008153186 (Normal approximation is higher). 

2.3, This value is given by `pnorm(17.5, mean = 17.25,sd = 3.361) - pnorm(16.5, mean = 17.25,sd = 3.361)` = 0.1179368, versus the Binomial's value 0.1180887 (Normal approximation is slightly smaller).
