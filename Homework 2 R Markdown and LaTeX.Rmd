...
In this circumstance, we use $\lambda$ as the overall rate for the country adjusted for the NYC population, such that 5 per million at a population of 8.3 million expects a rate of $\lambda = 41.5$ cases in a given year. Terefore,
$P(X=30) = frac{41.5^{30}{e^{-41.5}{30!}$  = $P(X=x)=\frac{41.5^{30} e^{-41.5}}{30!}$ 
